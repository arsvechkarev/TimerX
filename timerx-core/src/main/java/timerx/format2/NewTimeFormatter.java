...
public class NewTimeFormatter {
  ...
  public final NewSemantic semantic;
  private final NewTimeContainer timeContainer = new NewTimeContainer();
  private final StringBuilder mutableString;

  public NewTimeFormatter(NewSemantic semantic) {
  ...
  public CharSequence format(long millis) {
    NewTimeContainer units = timeUnitsOf(millis);
  ...
  private NewTimeContainer timeUnitsOf(long millis) {
