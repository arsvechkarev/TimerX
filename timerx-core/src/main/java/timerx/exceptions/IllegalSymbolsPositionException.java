 ...
 * unambiguous way to replace special symbols with corresponding time. Keep in mid that format
 * can contain same special symbols together, but not separately ("MMM:SSS" - is correct
 * format, "MM:SS:MM" - not)
 *
